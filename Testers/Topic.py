...
frame=Frame(root,width=w,height=h,bg="#34475F")
frame.pack(expand = 1)
...
def Difficulty():
    global f
    f=Frame(root,width=w,height=h,bg="#34475F")
    f.pack(expand = 1)
    f.pack_propagate(0)
...
def Unit():
    ...
    one = Button(f0, text="Unit 1",command=lambda: importQuestionsUnit("1"),font=(None,35),width=w, fg="white", bg="green", bd=0, anchor='center')
    one.pack(expand=1)#The height of the button. If the button displays text, the size is given in text units.

    two = Button(f0, text="Unit 2",command=lambda: importQuestionsUnit("2"),font=(None,35),width=w, fg="white", bg="orange", bd=0, anchor='center')
    two.pack(expand=1)
...
#*****************************************************      
Button(frame,text="Unit",command=lambda: quiz_type("U")).pack()
Button(frame,text="Difficulty",command=lambda: quiz_type("D")).pack()
